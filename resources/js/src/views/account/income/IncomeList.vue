  ...
  <div id="data-list-list-view" class="data-list-container">
    <vs-table ref="table" multiple v-model="selected" pagination :max-items="itemsPerPage" search :data="dataObjects">
      ...
      <template slot="thead">
        ...
        <vs-th sort-key="title">អង្គភាព</vs-th>
        <vs-th sort-key="account">គណនី</vs-th>
        <vs-th sort-key="category">ប្រភេទ</vs-th>
        <vs-th sort-key="issue_date">ថ្ងៃចំណូល</vs-th>
        <vs-th sort-key="payment_method">ទទួលចំណូលតាមរយៈ</vs-th>
        <vs-th sort-key="amount">ទឹកប្រាក់</vs-th>
        ...
        <template slot-scope="{data}">
          <tbody>
            <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
              ...
              <vs-td>
                <p class="product-name font-medium truncate">{{ tr.entity }}</p>
              </vs-td>
              <vs-td>
                <p class="product-name font-medium truncate">{{ tr.account }}</p>
              </vs-td>
              <vs-td>
                <p class="product-name font-medium truncate">{{ tr.category }}</p>
              </vs-td>
              <vs-td>
                <p class="product-name font-medium truncate">{{ tr.issue_date }}</p>
              </vs-td>
              <vs-td>
                <p class="product-name font-medium truncate">{{ tr.payment_method }}</p>
              </vs-td>
              <vs-td>
...
export default {
  ...
  methods: {
    addNewData() {
      this.$router.push('/account/income/form').catch(() => {})
      // this.sidebarData = {}
    ...
    editData(data) {
      ...
      // this.toggleDataSidebar(true)
      this.$router.push('/account/income/edit/' + data.id).catch(() => {})
    },
