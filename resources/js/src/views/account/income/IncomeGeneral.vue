<template>
  <vx-card no-shadow>
    ...
    <div class="vx-row">
      ...
      <div class="vx-col md:w-1/2 w-full mt-5">
        <label for="" class="vs-input--label">ថ្ងៃបង់ចំណូល</label>
        <datepicker v-validate="'required'" placeholder="ថ្ងៃបង់ចំណូល" name="issue_date" v-model="issue_date"></datepicker>
