...
<template>
  <div id="data-list-list-view" class="data-list-container">
    ...
    <vs-table ref="table" multiple v-model="selected" pagination :max-items="itemsPerPage" search :data="dataObjects">
      ...
      <template slot="thead">
        <vs-th>ល.រ</vs-th>
        <vs-th sort-key="name">ឈ្មោះគណនី</vs-th>
        <vs-th sort-key="account_number">លេខគណនី</vs-th>
        <vs-th sort-key="account_group">ក្រុមគណនី</vs-th>
        <vs-th sort-key="account_type">ប្រភេទគណនី</vs-th>
        <vs-th sort-key="issue_date">ថ្ងៃដាក់ដំណើរការ</vs-th>
        ...
        <template slot-scope="{data}">
          <tbody>
            <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
              ...
              <vs-td>
                <p @click.stop="editData(tr)" class="product-name font-medium truncate">{{ tr.account_number }}</p>
              </vs-td>
              <vs-td>
                <p @click.stop="editData(tr)" class="product-name font-medium truncate">{{ tr.account_group }}</p>
              </vs-td>
              <vs-td>
                <p @click.stop="editData(tr)" class="product-name font-medium truncate">{{ tr.account_type }}</p>
              </vs-td>
              <vs-td>
                <p @click.stop="editData(tr)" class="product-name font-medium truncate">{{ tr.issue_date }}</p>
              </vs-td>
