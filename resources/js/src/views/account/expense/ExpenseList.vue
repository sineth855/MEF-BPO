  ...
  <div id="data-list-list-view" class="data-list-container">
    <vs-table ref="table" multiple v-model="selected" pagination :max-items="itemsPerPage" search :data="dataObjects">
      ...
      <template slot="thead">
        ...
        <vs-th sort-key="issue_date">ថ្ងៃចំណាយ</vs-th>
        <vs-th sort-key="payment_method">ចំនាយតាមរយៈ</vs-th>
...
export default {
  ...
  methods: {
    addNewData() {
      this.$router.push('/account/expense/form').catch(() => {})
      // this.sidebarData = {}
    ...
    editData(data) {
      ...
      // this.toggleDataSidebar(true)
      this.$router.push('/account/expense/edit/' + data.id).catch(() => {})
    },
