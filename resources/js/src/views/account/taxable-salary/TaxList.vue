  ...
  <div id="data-list-list-view" class="data-list-container">
    <vs-table ref="table" multiple v-model="selected" pagination :max-items="itemsPerPage" search :data="dataObjects">
      ...
      <template slot="thead">
        ...
        <vs-th sort-key="taxable_salary">ភាគបៀវត្សជាប់ពន្ធប្រចាំខែ</vs-th>
        <vs-th sort-key="rate">អត្រា(%)</vs-th>
        <vs-th sort-key="account">លម្អៀងលើសប្រាក់ពន្ធតាមថ្នាក់</vs-th>
        <vs-th sort-key="order_level">តាមលំដាប់</vs-th>
        <vs-th sort-key="category">សម្គាល់</vs-th>
        ...
        <template slot-scope="{data}">
          <tbody>
            <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
              ...
              <vs-td>
                <p class="product-name font-medium truncate">{{ tr.taxable_salary_monthly_from }}{{tr.currency_symbol}} - {{ tr.taxable_salary_monthly_to }}({{tr.currency_symbol}})</p>
              </vs-td>
              <vs-td>
                <p class="product-name font-medium truncate">{{ tr.rate }}</p>
              </vs-td>
              <vs-td>
                <p class="product-name font-medium truncate">{{ tr.over_class_tax }}({{tr.currency_symbol}})</p>
              </vs-td>
              
              <vs-td>
                <p class="product-name font-medium truncate">{{ tr.order_level }}</p>
              </vs-td>
...
export default {
  ...
  methods: {
    addNewData() {
      this.$router.push('/account/taxable-salary/form').catch(() => {})
      // this.sidebarData = {}
    ...
    editData(data) {
      ...
      // this.toggleDataSidebar(true)
      this.$router.push('/account/taxable-salary/edit/' + data.id).catch(() => {})
    },
