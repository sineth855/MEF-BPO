  ...
  <div id="data-list-list-view" class="data-list-container">
    ...
    <vs-table ref="table" multiple v-model="selected" pagination :max-items="itemsPerPage" search :data="dataObjects">
      ...
      <template slot="thead">
        ...
        <vs-th sort-key="code">កូដ</vs-th>
        <vs-th sort-key="abbreviation">អក្សរកាត់</vs-th>
        <vs-th sort-key="exchange_rate">អត្រាប្តូរប្រាក់</vs-th>
        <vs-th sort-key="symbol_left">និមិត្តសញ្ញាខាងឆ្វេង</vs-th>
        <vs-th sort-key="symbol_right">និមិត្តសញ្ញាខាងស្តាំ</vs-th>
        ...
        <template slot-scope="{data}">
          <tbody>
            <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
              ...
              <vs-td>
                <p @click.stop="editData(tr)" class="product-name font-medium truncate">{{ tr.name }}</p>
              </vs-td>

              <vs-td>
                <p @click.stop="editData(tr)" class="product-name font-medium truncate">{{ tr.code }}</p>
              </vs-td>
              
              <vs-td>
                <p @click.stop="editData(tr)" class="product-name font-medium truncate">{{ tr.abbreviation }}</p>
              </vs-td>

              <vs-td>
                <p @click.stop="editData(tr)" class="product-name font-medium truncate">{{ tr.rate }}</p>
              </vs-td>

              <vs-td>
                <p @click.stop="editData(tr)" class="product-name font-medium truncate">{{ tr.symbol_left }}</p>
              </vs-td>

              <vs-td>
                <p @click.stop="editData(tr)" class="product-name font-medium truncate">{{ tr.symbol_right }}</p>
              </vs-td>
...
export default {
  ...
  methods: {
    addNewData() {
      // this.$router.push('/setup/department/form').catch(() => {})
      this.sidebarData = {}
