  ...
  <div id="data-list-list-view" class="data-list-container">
    ...
    <vs-table ref="table" multiple v-model="selected" pagination :max-items="itemsPerPage" search :data="dataObjects">
      ...
      <template slot="thead">
        ...
        <vs-th sort-key="order_level">លំដាប់លេខរៀង</vs-th>
        <vs-th sort-key="order_level">ស្ថានភាព</vs-th>
        ...
        <template slot-scope="{data}">
          <tbody>
            <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
              ...
              <vs-td>
                <p @click.stop="editData(tr)" class="product-name font-medium truncate">{{ tr.order_level }}</p>
              </vs-td>

              <vs-td>
                <vs-chip v-if="tr.is_active == 1" :color="getOrderStatusColor('success')" class="product-order-status">សកម្ម</vs-chip>
