<template>
    ...
    <div id="invoice-page">
        <!-- Poup Data Table -->
        <vs-popup fullscreen title="រៀបចំកម្មវិធីចំណូល / ចំណាយប្រចាំឆ្នាំ" :active.sync="popupActive">
        ...
        <div class="vx-row">
          ...
          <div class="vx-col w-full sm:w-1/2 md:w-1/2 lg:w-1/2 xl:w-1/2 mb-base">
              <vx-card
                ...
                <center><h5 class="pb-4" style="line-height: 30px;"><b>រៀបចំកម្មវិធីចំណូល</b></h5></center>
            </vx-card>
          </div>
          ...
          <div class="vx-col w-full sm:w-1/2 md:w-1/2 lg:w-1/2 xl:w-1/2 mb-base">
            <vx-card
              ...
              code-toggler 
              @click="initProPlan(2)">
              <center><h5 class="pb-4" style="line-height: 30px;"><b>រៀបចំកម្មវិធីចំណាយ</b></h5></center>
            </vx-card>
          </div>
        </div>
    </div>
...
<script>
  ...
  export default{
    data() {
      return {
        title: "preparation_plan_income_expense_prog",
        popupActive: false,
        mailTo: "",
        proPlan: 1,
      }
