<template>
  ...
  export default {
    data() {
      return {
        title: "IncomeResult",
        api: apiConfig._apiGetIncomeImpleResult,
        dataAttributes: {
          tableStyle: 7,
          page_number: 1,
          offset: 0,
          ...
          headingReport: "CreditExpenseRule",
          actionButton: [
            {
              icon: "EditIcon",
        ...
        dataHeaders: {
          header1: {
            ...
            header4: {
                label: "ចំណាត់ថ្នាក់ចំណាយ",
                rowspan: 3,
                colspan: 0,
            },
            header5: {
                label: "ច្បាប់ហិរញ្ញវត្ថុ",
                rowspan: 0,
                colspan: 0,
            },
            header6: {
        ...
        data: {
          ...
          group_fields: { field1: "rev_group", field2: "rev_type", field3: "entity" },
          summary: [
            {
              chapter: "",
              account: "",
