    ...
    <vx-card title="" code-toggler>
      ...
      <div class="mt-5">
        <form-wizard color="rgba(var(--vs-primary), 1)" errorColor="rgba(var(--vs-danger), 1)" :title="null"
          ...
          <!-- Tab 1  -->
          <tab-content title="រៀបចំផែនការយុទ្ធសាស្ត្រថវិកា" class="mb-5" icon="feather icon-home"
            ...
            <vx-card title="ផែនការយុទ្ធសាស្ត្រថវិកា" code-toggler>
              <div class="mt-5">
                <vs-collapse>
                  <vs-collapse-item>
                    <div slot="header" style="color: #fff; background-color:#28c76f; padding: 10px;">អនុកម្មវិធី
                      អ្នកគ្រប់គ្រង
          ...
          <tab-content title="បោះពុម្ភ" class="mb-5" icon="feather icon-image" :before-change="validateStep3">
            ...
            <div class="vx-row">
              ...
              <div class="vx-col w-full sm:w-1/4 md:w-1/4 lg:w-1/4 xl:w-1/4 mb-base">
                <vx-card title="បោះពុម្ភ" title-color="#fff" card-background="primary" content-color="#fff" code-toggler>
                  <center>
                    <h5 class="pb-4" style="line-height: 30px;">កម្មវិធី អនុកម្មវិធី អ្នកគ្រប់គ្រង និងអង្គភាពទទួលខុសត្រូវ
                    </h5>
                  </center>
                  <p class="mb-3​">
              ...
              <!-- Background Color -->
              <div class="vx-col w-full sm:w-1/4 md:w-1/4 lg:w-1/4 xl:w-1/4 mb-base">
                <vx-card title="បោះពុម្ភ" title-color="#fff" card-background="danger" content-color="#fff" code-toggler>
                  <center>
                    <h5 class="pb-4" style="line-height: 30px;">ការគ្រោងចំណូល/ចំណាយប្រចាំឆ្នាំ សម្រាប់អង្គភាព</h5>
                  </center>
                  <p class="mb-3​">
                    <center><vs-button class="mt-4 mr-2 shadow-lg" type="border" color="#ffffff"
                        gradient-color-secondary="#CE9FFC">{{ $t("Download") }}</vs-button></center>
              ...
              <!-- Background Color -->
              <div class="vx-col w-full sm:w-1/4 md:w-1/4 lg:w-1/4 xl:w-1/4 mb-base">
                <vx-card title="បោះពុម្ភ" title-color="#fff" card-background="warning" content-color="#fff" code-toggler>
                  <center>
                    <h5 class="pb-4" style="line-height: 30px;">កំណត់តម្រូវការចំណាយសម្រាប់កម្មវិធី និងអនុកម្មវិធី</h5>
                  </center>
                  <p class="mb-3​">
                    <center><vs-button class="mt-4 mr-2 shadow-lg" type="border" color="#ffffff"
                        gradient-color-secondary="#CE9FFC">{{ $t("Download") }}</vs-button></center>
              ...
              <div class="vx-col w-full sm:w-1/4 md:w-1/4 lg:w-1/4 xl:w-1/4 mb-base">
                <vx-card title="បោះពុម្ភ" title-color="#fff" card-background="primary" content-color="#fff" code-toggler>
                  <center>
                    <h5 class="pb-4" style="line-height: 30px;">ការកំណត់តម្រូវការចំណាយសម្រាប់ក្រសួង-ស្ថាប័ន</h5>
                  </center>
                  <p class="mb-3​">
                    <center><vs-button class="mt-4 mr-2 shadow-lg" type="border" color="#ffffff"
                        gradient-color-secondary="#CE9FFC">{{ $t("Download") }}</vs-button></center>
