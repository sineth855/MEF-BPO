<template>
    <div id="table-demo">
        <h2>គម្រោងវិនិយោគសាធារណៈ</h2>
        <div class="vx-row">
            <!-- {{dataInfo | json}} -->
            <div class="vx-col lg: w - 1 / 2 w - full">
                <!-- Form Input Text -->
                <div class="mt-4">
                    <label class="mb-2">{{ $t("tet") }}</label>
        ...
        <div class="vx-row">
            <vs-alert icon="warning" active="true" color="primary" class="mt-5">
                <span>ហិរញ្ញប្បទានសន្យាផ្តល់</span>
            </vs-alert>
        ...
        <div class="vx-row">
            <vs-alert icon="warning" active="true" color="primary" class="mt-5">
                <span>តម្រូវការហិរញ្ញប្បទានបំពេញបន្ថែម</span>
            </vs-alert>
...
import { ref } from 'vue';
import FormPIP from '@/views/modules/budget-arrangement/pip/_form_pip.vue'
