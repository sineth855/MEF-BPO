<template>
  <div class="parentx sidebar-menu">
    ...
    <vs-sidebar
      ...
      <div @mouseenter="mouseEnter" @mouseleave="mouseLeave">
        ...
        <!-- Header -->
        <div style="background: rgb(56 239 135)" class="header-sidebar flex items-end justify-between" slot="header">

          <!-- Logo -->
          <router-link tag="div" class="vx-logo cursor-pointer flex items-center" to="/">
            <logo class="w-10 mr-4 fill-current text-primary" />
            <span class="vx-logo-text text-success" v-show="isMouseEnter || !reduce" v-if="title">{{ title }}</span>
          </router-link>
          <!-- /Logo -->
...
<style lang="scss">
.vs-sidebar-group, .navigation-header, .vs-sidebar--item, ul.vs-sidebar-group-items li,.content-wrapper, select, textarea, p, article, b, ul, li, button {
