...
use App\Models\Settings\ExpenditureType;
...
class ExpenditureTypeController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->view_title = $this->path.'.entry_expenditure_type';
        $this->db_table = new ExpenditureType;
    ...
    public function index(Request $request)
    {
        ...
        $data = array(
            ...
            "data" => $this->db_table::getExpenditureTypes($filter),
            "limit" => config_limit,
