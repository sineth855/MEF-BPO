...
use App\Models\Settings\AuditrailLog;
use Illuminate\Http\Request;
use Auth;
use DB;
use CommonService;

class AuditrailLogController extends Controller
{
    protected $db_table;
    ...
    public function __construct()
    {
        ...
        $this->view_title = $this->path.'.entry_auditrail_title';
        $this->db_table = new AuditrailLog;
    ...
    public function index(Request $request)
    {
        ...
        $data = array(
            ...
            "data" => AuditrailLog::getAuditrails($filter),
            "limit" => $filter["limit"],
            "total" => AuditrailLog::getCount($filter)
        );
