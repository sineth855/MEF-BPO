...
use App\Models\Settings\ExpenditureGroup;
use Illuminate\Http\Request;
use Auth;
use DB;
use CommonService;

class ExpenditureGroupController extends Controller
{
    protected $db_table;
    ...
    public function __construct()
    {
        ...
        $this->view_title = $this->path.'.entry_expenditure_group';
        $this->db_table = new ExpenditureGroup;
    ...
    public function index(Request $request)
    {
        ...
        $data = array(
            ...
            "data" => $this->db_table::getExpenditureGroups($filter),
            "limit" => config_limit,
