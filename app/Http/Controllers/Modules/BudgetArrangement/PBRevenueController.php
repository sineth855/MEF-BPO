...
class PBRevenueController extends Controller
{
    protected $db_table;
    ...
    public function __construct()
    {
        ...
        $this->view_title = $this->path.'.entry_revenue_title';
        $this->db_table = new PBRevenue;
    ...
    public function index(Request $request)
    {
        ...
        $table = PBRevenue::getRevenues();//collect($whereClause->get());
        $data = array(
            "data_fields" => $this->dataFields(),
            "data" => $table,
            "limit" => LIMIT,
            "total" => PBRevenue::count()
        );
